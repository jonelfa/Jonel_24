...
💡 Passionate about creating **digital experiences** that are **robust, functional, and user-friendly**, blending both **code & design**.  
⚡ I enjoy solving problems, building projects, and continuously **learning new tech**.

---

## 🎯 My Goals
- 📚 Become a **Full-Stack Web & Mobile Developer** 💻📱  
- 🎨 Master **UI/UX Design** (Figma & Adobe XD) ✨  
- 🖌️ Enhance **Graphic Design** skills (Photoshop & Canva) 🖼️  
- 🐘 Deep dive into **PHP & Databases** for enterprise-level apps 🚀  
...
💼 **LinkedIn (Soon):** *Building my professional profile!*  
